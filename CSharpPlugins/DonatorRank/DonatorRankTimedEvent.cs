namespace DonatorRank
{
    ...
    public class DonatorRankTimedEvent
    {
        ...
        public delegate void TimedEventFireDelegate(DonatorRankTimedEvent TimedEvent);

        public event TimedEventFireDelegate OnFire;

        public DonatorRankTimedEvent(double interval)
        {
        ...
        public DonatorRankTimedEvent(double interval, Dictionary<string, object> args)
            : this(interval)
        {
            this.Args = args;
        }
